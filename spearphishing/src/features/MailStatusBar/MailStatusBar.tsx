...
export function MailStatusBar(){
    ...
    return (
        <div className="MailStatusBar">
            ...
            <h2>{7 - currentDay} days left</h2>
            </div>

            <div className='gameState'>
                <h2><span style={{fontWeight: 'lighter', color: 'rgba(255, 255, 255, 0.8)'}}>Money: </span> ${money}</h2>
                <h2 style={{color: 'rgba(255, 255, 255, 0.7)'}}>  </h2>
                <h2><span style={{fontWeight: 'lighter', color: 'rgba(255, 255, 255, 0.8)'}}>Data: </span> {data}mb</h2>
            </div>
        </div>
    )
}